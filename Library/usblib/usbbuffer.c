...
// 
// This is part of revision 6075 of the Stellaris USB Library.
//
//*****************************************************************************
...
ScheduleNextTransmission(const tUSBBuffer *psBuffer)
{
    ...
    if(ulPacket)
    {
        ...
        //
        // How much total data to we have in the buffer?
        //
...
HandleDataRemaining(tUSBBuffer *psBuffer)
{
    ...
    //
    // How much data does the client current have buffered?
    //
